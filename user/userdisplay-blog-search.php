                        ...
                        <div class="modal-body">
                            ...
                            <div class="collapse" id="collapseArticle">
                                ...
                                <div class="card card-body mb-1">
                                    <a class="text-dark" href="userdisplay-blog-view.php?blog_id=<?php echo $qtsrow['blog_id']; ?>"><?php echo $artrow['title']; ?></a>
                                </div>
                                <?php 
                                    }
                                ?>
                            ...
                            <div class="collapse" id="collapseDBM">
                                ...
                                ?>
                                <div class="card card-body mb-1">
                                    <a class="text-dark" href="userdisplay-blog-view.php?blog_id=<?php echo $qtsrow['blog_id']; ?>"><?php echo $dbrow['title']; ?></a>
                                </div>
                                <?php 
                                    }
                                ?>
                            ...
                            <div class="collapse" id="collapseITT">
                                ...
                                ?>
                                <div class="card card-body mb-1">
                                    <a class="text-dark" href="userdisplay-blog-view.php?blog_id=<?php echo $qtsrow['blog_id']; ?>"><?php echo $itrrow['title']; ?></a>
                                </div>
                                <?php 
                                    }
                                ?>
                            ...
                            <div class="collapse" id="collapseMoti">
                                ...
                                ?>
                                <div class="card card-body mb-1">
                                    <a class="text-dark" href="userdisplay-blog-view.php?blog_id=<?php echo $qtsrow['blog_id']; ?>"><?php echo $mtvrow['title']; ?></a>
                                </div>
                                <?php 
                                    }
                                ?>
                            ...
                            <div class="collapse" id="collapseProg">
                                ...
                                ?>
                                <div class="card card-body mb-1">
                                    <a class="text-dark" href="userdisplay-blog-view.php?blog_id=<?php echo $qtsrow['blog_id']; ?>"><?php echo $prgrow['title']; ?></a>
                                </div>
                                <?php 
                                    }
                                ?>
